Nedlands Golf Club - Members' Scoring PWA
=================================================
...
UPDATING
  ...
  (Cache name is stamped with the build hash: 9781fafa)

DATA
  Everything is stored on-device via localStorage under the "ngc:" prefix.
